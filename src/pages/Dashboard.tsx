    ...
    <div className="min-h-screen prevent-gradient-bg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-gray-600 font-roboto">Панель управления здоровьем</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8 animate-fade-in">
          <h2 className="text-2xl md:text-4xl font-montserrat font-bold text-gray-900 mb-2 md:mb-3">
            ...
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="prevent-icon-container bg-purple-100 w-8 h-8 md:w-12 md:h-12">
                  <Brain className="w-4 h-4 md:w-6 md:h-6 text-purple-600" />
                </div>
              </div>
            </CardContent>
          </Card>
