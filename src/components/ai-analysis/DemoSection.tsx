    ...
    <section className="py-16 px-4 md:px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-700 mb-6">Пример анализа</h2>
          <p className="text-lg text-gray-600 mb-8">Посмотрите, как работает наш ИИ</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-4">Интерактивная демонстрация</h3>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-4">Пример PDF-отчета</h3>
              <p className="text-gray-600 mb-6">
